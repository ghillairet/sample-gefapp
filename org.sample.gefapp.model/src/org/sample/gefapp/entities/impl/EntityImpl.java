 ...
 * <ul>
 *   <li>{@link org.sample.gefapp.entities.impl.EntityImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.sample.gefapp.entities.impl.EntityImpl#getSuperType <em>Super Type</em>}</li>
 *   <li>{@link org.sample.gefapp.entities.impl.EntityImpl#getFeatures <em>Features</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EntityImpl extends MinimalEObjectImpl.Container implements Entity {
	...
	public EList<Feature> getFeatures() {
		if (features == null) {
			features = new EObjectContainmentEList<Feature>(Feature.class, this, EntitiesPackage.ENTITY__FEATURES);
		}
		return features;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EntitiesPackage.ENTITY__FEATURES:
