...
public class CloneFeature3001Command extends CommandWrapper {
	 ...
	 * @generated
	 */
	public CloneFeature3001Command(View parentView, Node childNode,
	...
	private Command createAfterCopyCommand() {
		...
		result.append(AddCommand.create(editingDomain, parentView.getElement(), EntitiesPackage.eINSTANCE.getEntity_Features(), copyResult));
		if (constraint != null) {
			constraint.union(new Dimension(40, 40));
		}
		result.append(new CreateNotationalNodeCommand(parentView, copyResult, constraint, FeatureViewFactory.INSTANCE));
		return result;
	}
	/**
	 * @generated
