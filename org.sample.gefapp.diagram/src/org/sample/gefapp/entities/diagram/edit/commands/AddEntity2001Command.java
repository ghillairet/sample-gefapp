...
public class AddEntity2001Command extends CommandWrapper {
	 ...
	 * @generated
	 */
	public AddEntity2001Command(View parentView, Node childNode,
	...
	protected Command createCommand() {
		...
		result.append(AddCommand.create(editingDomain, parentView.getElement(),
				EntitiesPackage.eINSTANCE.getDomainModel_Entities(), element));
		result.append(RemoveCommand.create(editingDomain,
		...
		if (newVisualID == oldVisualID) {
			...
			result.append(new CreateNotationalNodeCommand(parentView, element,
					constraint, EntityViewFactory.INSTANCE));
		}
		return result;
	}
}
