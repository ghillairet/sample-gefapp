 ...
 * @generated
 */
public class EntityNameEditPart extends AbstractGraphicalEditPart
		implements
			ILabelController {
	 ...
	 * @generated
	 */
	public EntityNameEditPart(View model, ClientFactory clientFactory) {
	...
	private static ILabelTextDisplayer createLabelTextDisplayer() {
		return new MessageFormatLabelTextDisplayer(null, null, null,
				new EAttribute[]{EntitiesPackage.eINSTANCE.getEntity_Name()});
	}
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	private EntityEditPart getUpdatableParent() {
		assert getParent() instanceof EntityEditPart;
		return (EntityEditPart) getParent();
	}
	/**
	 * @generated
	 */
	public void activate() {
		super.activate();
		EntityEditPart updatableParent = getUpdatableParent();
